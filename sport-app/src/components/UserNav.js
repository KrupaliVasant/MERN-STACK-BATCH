                    ...
                    <div class="collapse navbar-collapse">
                        ...
                        <div class="text-end">
                            <ul className="nav">
                                ...
                                <li><NavLink className="btn btn-outline-light me-3 hvr-float-shadow" exact to='/login' activeClassName="btn btn-light text-dark" onClick={handleSubmit}>Log Out</NavLink></li>
